...
| Engagement range (03.04) | ⚠️ **2" horizontally**, 5" vertically (widened in 11th) | On our grid: **adjacent squares (diagonals count)** = engaged — since ADR 0007 (1 square = 2", Chebyshev) this is the *measured* 2" range, no longer a convention. Distances confirmed visually on the rasterized page (numerals-as-graphics check). |
